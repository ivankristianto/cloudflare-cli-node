...
exports.handler = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(argv) {
    var fields, filterId, separator, zoneId, format, response, results;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            fields = argv.fields, filterId = argv.filterId, separator = argv.separator, zoneId = argv.zoneId;
            format = argv.format;
            ...
            _context.next = 6;
            return _filters["default"].get(zoneId, filterId);
